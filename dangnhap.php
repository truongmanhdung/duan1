...
<div class="container-fuild" style="background: linear-gradient( 90deg, #f65e38 0, #f68a39 51%, #f65e38);">
    <div class="container  pt-5 pb-5" style="width: 1260px;">
        ...
        <span class="text-light pt-1">Nhanh chóng, tiện lợi và an toàn. Đăng ký liền tay, rinh ngay quyền lợi.</span>
    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12 pb-5">
                    <div class="media ">
                        ...
                        <p class="">Tích điểm đối với mỗi lượt đặt chỗ thành công. Quy đổi thành Lux Credit để du lịch nhiều hơn nữa.</p>
                    </div>
                </div>
            ...
            <div class="account">
                    ...
                    <?php 
                        if(isset($_POST['submit_login'])){
                            ...
                            if($email === "admin@123" & $password === "admin"){
                                setcookie("admin",md5($email),time() + (86400*30),"/");
                ...
                <div class="center-xs p-4  repass">
                    ...
                    <div class="repass mt-4">
                        ...
                        <a href="dangky.php" class="fw-bold text-decoration-none">
                            Đăng ký
                        </a>
                    </div>
