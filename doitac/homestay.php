        ...
        if ($_COOKIE['doitac']) {
            ...
            if ($result_hs->num_rows > 0) {
                ...
                while ($row_hs = $result_hs->fetch_assoc()) {
                    ...
                    echo '
                            <tr>
                                <td style="font-size:14px;vertical-align: middle;" class="text-center">' . $dem . '</td>
                                <td style="font-size:14px;vertical-align: middle;" class="text-center"><a href="homestaydetail.php?id=' . $row_hs['id'] . '">' . $name . '</a></td>
                                <td style="font-size:14px;vertical-align: middle;" class="text-center">' . number_format($price) . ' đ</td>
                                <td style="font-size:14px;vertical-align: middle;" class="text-center">' . $address . '</td>
                                <td style="font-size:14px;vertical-align: middle;" class="text-center">' . $phone . '</td>
                                <td style="font-size:14px;vertical-align: middle;" class="text-center">
                                    <img src="../public/image/homestay/' . $image . '" style="width: 100px;" alt="">
                                </td>
                                <td style="font-size:14px;vertical-align: middle;" class="text-center">' . $sophong . '</td>
                                <td style="font-size:14px;vertical-align: middle;" class="text-center">' . $namekv . '</td>
                                <td style="font-size:14px;vertical-align: middle;" class="text-center">' . $time . '</td>
                                <td style="font-size:14px;vertical-align: middle;" class="text-center">
