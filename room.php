...
document.getElementById("hours").innerText = `0${Math.floor((distance % (day)) / (hour))}`.slice(-2),
            ...
            <?php
                ...
                }else if($result_timeall->num_rows >0){
                    echo '<div class="discount">
                    <div class="discount_title d-flex justify-content-between">
                        <p class="mb-0 bold">
                            FLASH SALE
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 ">
        ...
        <?php 
            if(isset($_POST['datngay'])){
                ...
                $sql_donhang = "INSERT INTO donhang VALUES (null,$id,$id_hs,'$name','$email','$address','$phone','$mahoadon',0,$giaphong,$tongtien,'$check_in','$check_out','$today')";
