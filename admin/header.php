            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="homestay.php">
                                <i class="fas fa-table"></i>Khách sạn</a>
                        </li>
                        <li>
                            <a href="message.php">
                                <i class="fas fa-table"></i>Tin nhắn</a>
                        </li>
                        <li>
                    ...
                    <div class="header-button">
                        <div class="noti-wrap">
                            <div class="noti__item js-item-menu">
                                ...
                                <?php 
                                    $sql_message = "SELECT * FROM message WHERE status = 0";
                                    ...
                                    if($result_message->num_rows > 0){
                                        ...
                                        echo '<span class="quantity">'.$dem.'</span>
                                            <div class="mess-dropdown js-dropdown">
                                            <div class="mess__title">
                                                <p>You have '.$dem.' news message</p>
                                            </div>
                                        ';
                                    }
                                ?>
                                    <?php 
                                        $sql_mess = "SELECT DISTINCT id_user FROM message LIMIT 2";
                                        $result_mess = $conn->query($sql_mess);
                                        if($result_mess->num_rows > 0){
                                            while($row_message = $result_mess->fetch_assoc()){
                                                $id_user = $row_message['id_user'];
                                                $sql_message = "SELECT * FROM message WHERE status = 0 and id_user = $id_user LIMIT 1";
                                                $result_message = $conn->query($sql_message);
                                                if($result_message->num_rows > 0){
                                                    while($row_message = $result_message->fetch_assoc()) {
